package com.vpon.ssp.report.archive.simulator
...
import com.vpon.ssp.report.archive.kafka.producer.CustomPartitionProducer
import com.vpon.ssp.report.archive.generator.EventGenerator
...
object GroupedEventsSimulator extends App with GeneratorDrivenPropertyChecks {
  ...
  val parser = new scopt.OptionParser[ArgumentOptions]("ssp-archive-grouped-event-simulator") {
    head("ssp-archive-grouped-event-simulator", "0.0.1")
